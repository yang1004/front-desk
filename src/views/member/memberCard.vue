    ...
    <div class="memberUpgrade">
        <div class="member-card-memu">
            <div class="member-card-box">
                <div class="member-card-title">{{$t('member.hyhk')}}</div>
                <div class="member-card-content" v-if="fristMemu">
                    ...
                    <div class="icon-name-box">
                        ...
                        <div class="right">{{$t('member.srxhykh')}}</div>
                    </div>
                    <p class="tips">{{$t('member.sryhykh')}}</p>
                ...
                <div class="member-card-content" v-else>
                    ...
                    <p class="memberNumber-tips">{{$t('member.yhykh')}}：{{userInfo.m_number}}</p>
                    <p class="member-type-name">{{$t('member.srxhykh')}}</p>
                    <div class="days-box">
                        <el-input v-model="days"></el-input>
                        <span class="success">{{$t('member.hkcgh')}}</span>
                    </div>
                    <div class="days-box">
                        <div class="left">
                            {{$t('member.hyxm')}}：{{userInfo.mname}}
                        </div>
                        <div class="right">
                    ...
                    <div class="days-box">
                        <div class="left">
                            {{$t('member.dqye')}}：{{userInfo.balance}} {{$t('dashboard.y')}}
                        </div>
                        <div class="right">
    ...
    export default {
        ...
        methods: {
            ...
            commit(){
                ...
                api.changeMemberNumber({
                    membernumber:this.userInfo.m_number,
                    newnumber:this.days
                }).then(res=>{
                    loading.close();
                    if(res.data.code == 200){                        
