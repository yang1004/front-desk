    ...
    <div class="memberRecharge">
        <div class="member-card-memu">
            <div class="member-card-box">
                <div class="member-card-title">{{$t('member.hykzjjf')}}</div>
                <div class="member-card-content" v-if="fristMemu">
                    ...
                    <div class="icon-name-box">
                        ...
                        <div class="right">{{$t('member.zjhyjf')}}</div>
                    </div>
                    <p class="tips">{{$t('member.srzjjfkh')}}</p>
                ...
                <div class="member-card-content" v-else>
                    ...
                    <div class="days-box">
                        <div class="left">
                            <p class="member-type-name">{{$t('member.bczjjf')}}</p>
                            <div class="money-box">
                                <el-input v-model="money"></el-input><span class="danwei">{{$t('member.d')}}</span>
                            </div>
                        </div>
                    </div>
                    <p class="member-type-name">{{$t('member.jfsy')}}</p>
                    <div class="remarks">
    ...
    export default {
        ...
        methods: {
            ...
            getMemberInfo(){
                ...
                //         // this.adminLog('会员增加积分获取会员卡号信息')
                //         this.fristMemu = false
                //         this.userInfo = res.data.data[0]
                //     }else{
                //         // this.adminLog('会员增加积分获取会员卡号信息失败')
                //         this.$message({
            ...
            commit(){
                ...
                api.addIntegral({
                    ...
                    loading.close();
                    if(res.data.code == 200){
                        // this.adminLog('会员增加积分成功')
                        this.$message({
                            message: this.$t('member.zjcg'),
                            type: 'success'
                        });
                        this.$router.push({name:'memberList'})
                    }else{
                        // this.adminLog('会员增加积分失败')
                        this.$message({
                            message: res.data.data,
                            type: 'success'
                        });
